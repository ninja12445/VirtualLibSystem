...
/*    
Programming technique use to reference 
    constructor call 
    ...
    => Main(int arg1, int arg2)
    inside the first constructor , we use this keyword to call the second constructor 
    
    this(5, 2); 
    Here the second constructor is called from the first constructor by passing arguments 5 and 2
    
    ====
    Try out learning to pass lambda expression as the method argument 
    ...
    languages.replaceAll(e-> e.toUpperCase()); this line is a lambda expression. It takes all elements of the arraylist and converts them into uppercase 
    System.out.println("Updated Array List: " + languages;
    
    LinkedHashSet,  removes elements and maintains insertion order 
    create an array list named numbers. Arraylist contains duplicate elements 
    ...
    add all elements from set to array list 
    ...
    .add (E e) add specific elements 
    .size() returns the numbers of elements in this set (cardinality)
    .contains(element) check whether a specific element is present in the set ,
